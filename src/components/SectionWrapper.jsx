export default function SectionWrapper(props) {
  ...
  return (
    <section id={id} className="min-h-screen flex flex-col">
      <div className="bg-gradient-to-r from-blue-900 to-blue-800 dark:from-dark-accent-main dark:to-dark-accent-dark text-white py-16 flex flex-col gap-6 justify-center items-center">
